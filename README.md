This repository contains the sources for the base SonarQube plugin that is used by the [SonarQube Roslyn SDK](https://github.com/SonarSource-VisualStudio/sonarqube-roslyn-sdk).
